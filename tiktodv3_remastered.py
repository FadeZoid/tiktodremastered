...
system("cls")
os.system('title TIKTOD REMAKE V3.1')
print(pyfiglet.figlet_format("TIKTOD V3", font="slant"))
print("Author: https://github.com/FadeZoid/tiktodremastered\n")
print("Choose option to begin botting\n1. Auto Views\n2. Auto Hearts\n3. Auto Followers\n ")
...
def loop1():
    ...
    try:
        ...
        print("> [CAPTCHA FOUND] Array:SolveCaptcha\n> Solve the captcha!")
        print("Edit the code with a captchamonster or hcapbypass key to stop the manual encounter of this. ONLY ONE TIME CAPTCHA SOLVE.")
        driver.refresh()
        loop1()
    try:
        sleep(2)
